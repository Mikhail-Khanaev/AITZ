(() => {
    ...
    function addTouchClass() {
        if (isMobile.any()) {
            ...
            let menuLinksArr = document.querySelectorAll(".menu__link-arr");
            if (menuLinksArr.length > 0) for (let index = 0; index < menuLinksArr.length; index++) {
                const menuArrow = menuLinksArr[index];
    ...
    da.init();
    let buttonClose = document.querySelector(".top-header__close");
    ...
    let searchIcon = document.querySelector(".search-header__button");
    let searchInput = document.querySelector(".search-header__input");
